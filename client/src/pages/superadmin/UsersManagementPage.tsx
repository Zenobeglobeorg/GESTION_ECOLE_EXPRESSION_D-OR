    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className={`pt-16 transition-all duration-300 ${isSidebarCollapsed ? 'lg:ml-28' : 'lg:ml-64'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* En-tête */}
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Gestion des Utilisateurs et Élèves</h1>
            <p className="text-gray-600">Créez et gérez tous les comptes utilisateurs et élèves du système</p>
          </div>
          ...
          {viewType === 'users' ? (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                {roles.map((role) => (
                  <div
                    key={role.value}
                    className={`cursor-pointer ${selectedRole === role.value ? 'ring-2 ring-yellow-400 rounded-lg' : ''}`}
            ...
            <Card className="mb-6 border-0 shadow-lg">
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                <p className="text-gray-600">Liste de tous les élèves inscrits dans le système</p>
                <Button
          ...
          <Card className="border-0 shadow-lg">
            {isLoading ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">Chargement {viewType === 'users' ? 'des utilisateurs' : 'des élèves'}...</p>
              </div>
            ) : viewType === 'users' ? (
              ...
              students.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 mb-2">Aucun élève inscrit</p>
                  <p className="text-sm text-gray-400">Commencez par inscrire votre premier élève</p>
                </div>
              ) : (
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                              ...
                              <div>
                                ...
                                <div className="flex gap-2 mt-1">
                                  {student.hasDisability && (
                                    <span className="text-xs text-orange-600">Handicap</span>
                                  )}
                                  {student.isOrphan && (
                                    <span className="text-xs text-red-600">Orphelin</span>
                                  )}
                                </div>
                              </div>
                            </div>

...
export const ParentAccountsPage = () => {
  ...
  const loadUsers = async () => {
    try {
      ...
      const parentUsers = data.filter(user => user.role === 'PARENT') as UserWithDate[];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-3xl font-bold text-gray-900">Gestion des Comptes Parents</h1>
              <span className="px-3 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                {users.length} compte(s)
              </span>
            </div>
            <p className="text-gray-600">Créez et gérez les comptes des parents</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <Card className="border-0 shadow-md bg-linear-to-br from-yellow-500 to-yellow-600">
              <div className="p-6 text-white">
                ...
                <p className="text-white text-opacity-90 text-sm mb-1 font-medium">Total Parents</p>
          ...
          <Card className="mb-6 border-0 shadow-lg">
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              <p className="text-gray-600">Liste de tous les comptes parents</p>
              <Button
          ...
          <Card className="border-0 shadow-lg">
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mb-2">Aucun compte parent créé</p>
                <p className="text-sm text-gray-400">Commencez par créer un compte parent</p>
              </div>
            ) : (
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {users.map((user) => (
                      <tr key={user.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">Parent</span>
                        </td>
      ...
      <Modal
        ...
        title="Créer un Nouveau Compte Parent"
        size="lg"
      >

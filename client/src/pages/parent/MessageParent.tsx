    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Communiquez avec l'administration de l'école.
        </p>
      </div>

      {error && (
        <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-xl p-3 md:p-4 text-sm md:text-base text-red-700 dark:text-red-400">
          {error}
        </div>
      )}
      ...
      {!isConnected && (
        <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-xl p-3 md:p-4 text-sm md:text-base text-yellow-700 dark:text-yellow-400">
      ...
      {!showConversations && !selectedConversation && (
        <button
          ...
          className="md:hidden fixed bottom-4 right-4 bg-blue-600 dark:bg-blue-700 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 dark:hover:bg-blue-800 transition-colors z-10"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-[calc(100vh-250px)] md:h-[calc(100vh-300px)] min-h-[500px] md:min-h-[600px]">
        ...
        <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col ${
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <h3 className="font-semibold text-blue-900 dark:text-blue-400">Conversations</h3>
            <button
                        ...
                        <div
                          className={`inline-block p-3 rounded-2xl max-w-xs shadow-sm ${
                            isOwn
                              ...
                              : 'bg-blue-50 dark:bg-gray-700 text-blue-900 dark:text-gray-200 border border-blue-100 dark:border-gray-600'
                          }`}
                        >
                          {!isOwn && (
                          ...
                          <p className={`text-xs mt-1 ${
                            isOwn ? 'text-white/70' : 'text-blue-700/70 dark:text-gray-400'
                          }`}>
              ...
              <form onSubmit={handleSendMessage} className="p-3 md:p-4 border-t border-gray-200 dark:border-gray-700">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 md:px-6 py-2 bg-blue-600 dark:bg-blue-700 text-white text-sm md:text-base rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
